...
`,[Oe(x("&","--n-merged-color: var(--n-color-modal);")),Me(x("&","--n-merged-color: var(--n-color-popover);")),x("img",`
 width: 100%;
 height: 100%;
 `),f("text",`
 white-space: nowrap;
